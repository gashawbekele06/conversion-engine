...
def capacity_for(stack: str) -> dict[str, Any]:
    ...
    with tracer.trace("bench.capacity_for", stack=stack) as attrs:
        ...
        cap = summary["capabilities"].get(stack, {})
...
def can_commit(stack: str, engineers_requested: int,
    ...
    max_start = summary["hard_constraints"]["max_simultaneous_starts_per_week"]
    min_days = summary["hard_constraints"]["earliest_start_date_days_out"]
